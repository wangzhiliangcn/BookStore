...
namespace BookStore.WpfApp.Controls
{
    ...
    public class DMScrollViewer: ScrollViewer
    {
        ...
        public static readonly DependencyProperty themeBorderBrushProperty =
            DependencyProperty.Register("themeBorderBrush", typeof(SolidColorBrush), typeof(DMScrollViewer), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(255, 200, 200, 200))));
        #endregion
        ...
        public static readonly DependencyProperty themeBorderBrushMouseOverProperty =
            DependencyProperty.Register("themeBorderBrushMouseOver", typeof(SolidColorBrush), typeof(DMScrollViewer), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(255, 180, 180, 180))));
        #endregion
        ...
        public static readonly DependencyProperty themeBorderBrushPressedProperty =
            DependencyProperty.Register("themeBorderBrushPressed", typeof(SolidColorBrush), typeof(DMScrollViewer), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(255, 180, 180, 180))));
        #endregion
